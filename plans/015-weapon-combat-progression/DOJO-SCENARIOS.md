...
Gathering is now included in execution: [S15 — Named gathering sites and targeted progression](dojo/S15-gathering-sites.md), phases2–8. User authorization supersedes the earlier review-only status.
