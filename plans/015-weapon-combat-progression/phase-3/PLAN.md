...
5. Implement profile/collection/preview/battle/results screens through shared Scene/render/pane/tool contracts, following `PLAYER-EXPERIENCE.md`. Numbered replies, clicks, tap and keyboard use the same actions and instance IDs. Show actual paid-versus-exhausted state.
