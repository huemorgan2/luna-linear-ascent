...
14. Grade-art correction: in the Arsenal switch each grade for Breach Cleaver, Hawkeye Longbow, Ember Staff and Thunder Maul. Inspect the weapon geometry (blade/head/limbs/staff crown), not its frame. Each must have four different drawings. Open a weapon's side-by-side grade comparison and verify the selected portrait and Forge agree. Inspect four acquisition rows from one family. At390px every design and grade label must remain visible, no horizontal page overflow. Missing images, repeated silhouettes, wrong weapon categories or stale art after a selection fail this scenario.
